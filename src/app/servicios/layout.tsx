...
export const metadata: Metadata = {
  title: 'Servicios Digitales | Sirius - Desarrollo Web y Apps en Costa Rica',
  ...
  openGraph: {
    title: 'Servicios Digitales | Sirius Costa Rica',
    ...
    type: 'website',
    locale: 'es_CR',
    url: 'https://www.siriusx.net/servicios',
    siteName: 'Sirius',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Servicios Digitales Sirius Costa Rica',
      }
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.siriusx.net/servicios',
  },
};
