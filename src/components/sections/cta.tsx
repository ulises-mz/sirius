      ...
      <div className="contact-container">
        ...
        <div className="contact-methods-wrapper">
          ...
          <div className="contact-methods">
            <a href={`tel:${SITE.phone}`} className="contact-method">
              ...
              <div className="method-info">
                ...
                <span className="method-value">{SITE.phone}</span>
              </div>
            </a>

            <a href={`mailto:${SITE.primaryEmail}`} className="contact-method">
              <div className="method-icon-circle">
                <svg viewBox="0 0 24 24" fill="currentColor" className="method-icon">
              ...
              <div className="method-info">
                ...
                <span className="method-value">{SITE.primaryEmail}</span>
              </div>
            </a>

            <a href={`https://wa.me/${SITE.phone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="contact-method whatsapp">
              <div className="method-icon-circle">
                <svg viewBox="0 0 24 24" fill="currentColor" className="method-icon">
